...
const Wrapper: React.FC = ({ children }) => (
  <svg tw="min-w-[16px]" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
